...
import { GitPullRequest, FileText, GitBranch, Search, ArrowLeft, ExternalLink, Cpu } from "lucide-react";
...
export function ResultsDashboard({ state, onReset, onTabChange, aiConfig }: ResultsDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-6">
        ...
        {!summary && !executionFlow && !codeReview && (
